 ...
 * disconnect from the imap server
 */
ImapSimple.prototype.destroy = function () {
    var self = this;
 ...
 * @memberof ImapSimple
 */
ImapSimple.prototype.expunge = function (uids, callback) {
    var self = this;

    if (callback) {
        return nodeify(this.expunge(uids), callback);
    }

    return new Promise(function (resolve, reject) {

        self.imap.expunge(uids, function (err, result) {
...
ImapSimple.prototype.addBox = function (boxName, callback) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        self.imap.addBox(boxName, function (err, result) {
...
/**
 * Copies the specified message(s) in the currently open mailbox to another mailbox.
 *
 * @param {string|Array} source The node-imap `MessageSource` indicating the message(s) from the current open mailbox
 *  to move.
 * @param {string} boxName The mailbox to move the message(s) to.
 ...
 * @memberof ImapSimple
 */
ImapSimple.prototype.copyMessage = function (source, boxName, callback) {
    var self = this;

    if (callback) {
        return nodeify(self.copyMessage(source, boxName), callback);
    }

    return new Promise(function (resolve, reject) {
        self.imap.copy(source, boxName, function (err) {
            if (err) {
                reject(err);
                return;
            }
...
/**
 * removeDeleted a mime-encoded message to a mailbox
 *
 ...
 * @memberof ImapSimple
 */
ImapSimple.prototype.removeDeleted = function (callback) {
    var self = this;

    if (callback) {
        return nodeify(self.removeDeleted(), callback);
    }

    return new Promise(function (resolve, reject) {
        self.imap.removeDeleted(function (err) {
            if (err) {
                reject(err);
                return;
            }
